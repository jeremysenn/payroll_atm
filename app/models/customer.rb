...
#          send_barcode_sms_message
          send_barcode_sms_message_with_info("You've just been paid $#{amount.round(2)} by #{company.name}! Your current balance is $#{balance.round(2)}. Get your cash from the PaymentATM. More information at https://tranact.com")
        end
